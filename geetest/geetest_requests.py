...
def request_process(s):
    ...
    hd1 = {'Accept':'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
    ...
    #print challenge
    url3 = """http://api.geetest.com/getfrontlib.php?gt=%s&callback=geetest_%d"""%(gt, random.random()*10000+int(time.time()*1000) )
    hd3 = {'Accept':'*/*',
    'Accept-Encoding':'gzip, deflate, sdch',
    'Accept-Language':'zh-CN,zh;q=0.8',
    'Connection':'keep-alive',
    ...
    url4 = """http://api.geetest.com/get.php?gt=%s&challenge=%s&product=float&offline=false&type=slide&callback=geetest_%d"""%(gt, challenge, random.random()*10000+int(time.time()))
    hd4 = {'Accept':'*/*',
    'Accept-Encoding':'gzip, deflate, sdch',
    'Accept-Language':'zh-CN,zh;q=0.8',
    'Connection':'keep-alive',
    ...
    #print challenge
    hd5 = {'Accept':'image/webp,image/*,*/*;q=0.8',
    'Accept-Encoding':'gzip, deflate, sdch',
    'Accept-Language':'zh-CN,zh;q=0.8',
    'Connection':'keep-alive',
    'Host':'uems.sysu.edu.cn',
...
def position_process(xpos, s, gt, challenge, cookies):
    ...
    time.sleep(0.4)
    url6 = "http://api.geetest.com/ajax.php?gt=%s&challenge=%s&userresponse=%s&passtime=%s&imgload=%s&a=%s&callback=geetest_%d"%(gt, challenge,userresponse, passtime,imgload, enc_act, random.random()*10000+int(time.time()*1000))
...
def refresh(s, gt, challenge,cookies):
    url = "http://api.geetest.com/refresh.php?challenge=%s&gt=%s&callback=geetest_%d"%(challenge, gt, random.random()*10000+int(time.time()*1000))
    headers7 = {'Accept':'*/*',
'Accept-Encoding':'gzip,deflate,sdch',
'Accept-Language':'zh-CN,zh;q=0.8',
'Connection':'keep-alive',
